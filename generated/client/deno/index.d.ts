...
export namespace Prisma {
  ...
  */
  ...
  export type UsersSelect = {
    ...
    email?: boolean
    password?: boolean
    providers?: boolean | ProvidersFindManyArgs
    createdAt?: boolean
  ...
  export class Prisma__UsersClient<T, Null = never> implements PrismaPromise<T> {
    ...
    providers<T extends ProvidersFindManyArgs= {}>(args?: Subset<T, ProvidersFindManyArgs>): PrismaPromise<Array<ProvidersGetPayload<T>>| Null>;
